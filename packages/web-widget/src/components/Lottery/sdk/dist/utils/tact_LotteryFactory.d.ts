...
export declare const LotteryFactory_getterMapping: {
    [key: string]: string;
};
export declare class LotteryFactory implements Contract {
    static init(): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(): Promise<LotteryFactory>;
    static fromAddress(address: Address): LotteryFactory;
    ...
    }, message: CreateLottery | Draw | "createRefWallet" | "withdraw_ref" | EmergencyWithdraw | Deploy): Promise<void>;
    getLotteryCnt(provider: ContractProvider): Promise<bigint>;
    getLotteryAddress(provider: ContractProvider, seqno: bigint): Promise<Address>;
    getReferrerWalletAddress(provider: ContractProvider, user: Address): Promise<Address>;
    getReffererNumber(provider: ContractProvider, user: Address): Promise<bigint>;
