...
export declare const Lottery_getterMapping: {
    [key: string]: string;
};
export declare class Lottery implements Contract {
    static init(factory: Address, seqno: bigint): Promise<{
        code: Cell;
        data: Cell;
    }>;
    static fromInit(factory: Address, seqno: bigint): Promise<Lottery>;
    static fromAddress(address: Address): Lottery;
    ...
    }, message: CreateLottery | BuyTicket | "close" | "draw" | ClaimTickets | "widrawCommission" | "moveFunds" | "addFunds" | Withdraw): Promise<void>;
    getAllTickets(provider: ContractProvider): Promise<Dictionary<bigint, Ticket>>;
    getIsClaimable(provider: ContractProvider, user: Address): Promise<boolean>;
    getCalculateTotalPriceForBulkTickets(provider: ContractProvider, amount: bigint): Promise<bigint>;
    getWinningNumber(provider: ContractProvider): Promise<bigint>;
    getInfo(provider: ContractProvider): Promise<{
        $$type: "LotteryInfo";
        seqno: bigint;
        creator: Address;
        ticketCnt: bigint;
    ...
    getCalculateRewardsForTicketId(provider: ContractProvider, ticketId: bigint): Promise<bigint>;
}
